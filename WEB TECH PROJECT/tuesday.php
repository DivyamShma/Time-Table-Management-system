...
<?php
	...
	$sql = "select * from student_tuesday where Section=\"$section\";";
	$result = mysqli_query($conn,$sql);
	$resultCheck = mysqli_num_rows($result);

	$sql_f= "select Name,Email from faculty,tuesday,teach where tuesday.Course_code = teach.Course_code and teach.F_code = faculty.F_code and teach.Section=\"$section\";";
