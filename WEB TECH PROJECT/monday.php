...
<?php
	...
	$sql = "select * from student_monday where Section=\"$section\";";
	$result = mysqli_query($conn,$sql);
	$resultCheck = mysqli_num_rows($result);

	$sql_f= $sql = "select Name,Email from faculty,monday,teach where monday.Course_code = teach.Course_code and teach.F_code = faculty.F_code and teach.Section=\"$section\";";
