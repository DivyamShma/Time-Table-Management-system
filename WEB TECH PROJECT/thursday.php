...
<?php
$sql = "select * from student_thursday where Section=\"$section\";";
...
$sql_f= $sql = "select Name,Email from faculty,thursday,teach where thursday.Course_code = teach.Course_code and teach.F_code = faculty.F_code and teach.Section=\"$section\";";
...
<?php
$sql_lab = "select * from student_thurday_lab where Section=\"$section\" and Batch=$batch;;";
...
$sql_lab_f = "select distinct Name,Email from faculty,teach,lab where lab.Course_code = teach.Course_code and teach.F_code = faculty.F_code and day=\"Thursday\" and Batch=$batch;";
